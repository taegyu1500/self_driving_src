...
def launch(context):
    ...
    yolov5_node = Node(
        ...
        output='screen',
        parameters=[{'classes': ['straight', 'right', 'parking', 'red', 'green', 'crosswalk']},
            {"device": "cpu",
            "model": "traffic_signs",
    ...
    return [start_arg, only_line_follow_arg, depth_camera_launch, controller_launch, yolov5_node, self_driving_node]
